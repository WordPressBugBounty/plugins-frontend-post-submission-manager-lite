...
1. Form Lists
1. Frontend Post Submission Form Template 1
2. Frontend Post Submission Form Template 2
3. Frontend Post Submission Form Template 3
4. Frontend Post Submission Form Template 4
5. Frontend Post Submission Form Template 5
6. Frontend Post Submission Backend Basic Settings
7. Frontend Post Submission Backend Login Settings
8. Frontend Post Submission Backend Form Settings
9. Frontend Post Submission Backend Layout Settings
9. Frontend Post Submission Backend Notification Settings
...
* Updated maintenance fixes to keep the plugin compatible with current WordPress standards.
* Thanks to Artus KG for responsibly reporting the security issues addressed in this release.
...
= 1.2.4 = 
* Fixed text domain warning message
* Updated upgrade images and added free vs pro comparison
...
= 1.2.1 = 
* Updated price in upgrade to pro section

= 1.2.0 = 
* Fixed author selection issue in basic settings
* Fixed post format selection issue in basic settings
...
= 1.1.6 = 
* Fixed post admin link for admin notification Email
* Removed unncessary files
* Fixed HTML text editor issue

= 1.1.5 = 
* WP 6.2 compatiblity check

= 1.1.4 = 
* WP 6.1 compatiblity check

= 1.1.3 = 
* Added - support in meta key while adding custom fields

= 1.1.2 = 
* Changed details in upgrade section
